...
bool KirbyLifeIcon::Init()
{
	...
	Transform->SetLocalPos(-83.f, 40.f, 0.f);
	...
	//
	Animation->AddAnimation("GeneralRips", "LifeIcon", FVector2D(288.f, 336.f), FVector2D(24.f, 12.f), FVector2D(0.f, 0.f), 1, 1);
	Animation->ChangeState("LifeIcon", 0);
